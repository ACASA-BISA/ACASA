              ...
              <Paper elevation={1} sx={{ width: '100%', height: 'calc(100vh - 155px)' }}>
                ...
                <div ref={boxref1}>
                  ...
                  <Legend_Small location={activeRegion} commodity={activeCrop} adaption={activeOpt} RiskName={CurrRisk}
                      ...
                      open_yes={true} bottom_position={25} left_position={boxstart1+5} box_width={boxwidth1-10}></Legend_Small>
                </div>}
                {label==='2050s'&&
                <div ref={boxref2}>
                  ...
                  <Legend_Small location={activeRegion} commodity={activeCrop} adaption={activeOpt} RiskName={CurrRisk}
                      ...
                      open_yes={true} bottom_position={25} left_position={boxstart2+5} box_width={boxwidth2-10}></Legend_Small>
                </div>}
                {label==='2080s'&&
                <div ref={boxref3}>
                  ...
                  <Legend_Small location={activeRegion} commodity={activeCrop} adaption={activeOpt} RiskName={CurrRisk}
                      scenario='ssp245' ImpactName={activeImpact} area_data3={area_dict3} area_data4={area_dict4}
                      open_yes={true} bottom_position={25} left_position={boxstart3+5} box_width={boxwidth3-10}></Legend_Small>
                </div>}
              </Paper>
            </Grid>
          ))}
