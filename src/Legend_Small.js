  ...
  function fetchthedataTable() {
    ...
    if (adaption !== "") {
      ...
      const total =
        ...
        Number(row_data["Suitable with adaptation benefits"]);
      //console.log(total);
      /*data = [
        createData(
          <Box
          ...
          (row_data["Unsuitable Population"] * 0.16) / 1000000
        ),
        createData(
          <Box
            sx={{
          ...
          (row_data["Suitable Population"] * 0.16) / 1000000
        ),
        createData(
          <Box
            sx={{
          ...
          row_data["Suitable with adaptation benefits"] / 10,
          (
            (row_data["Suitable with adaptation benefits Population"] * 100) /
            total
          ).toFixed(2),
          (row_data["Suitable with adaptation benefits Population"] * 0.16) /
            1000000
        ),
      ];*/
      //console.log(data);

      // Experimental addition of another segment in a yellow color in the legend 
      data = [
        createData(
          <Box sx={{ width: '100%', height: 13, borderRadius: 0, bgcolor: 'rgba(180, 70, 109, 1)' }} />,
          'Unsuitable',
          row_data['Unsuitable'] / 10,
          (row_data['Unsuitable'] * 100 / total).toFixed(2),
          (row_data['Unsuitable Population'] * 0.16 / 1000000)
        ...
        createData(
          <Box sx={{ width: '100%', height: 13, borderRadius: 0, bgcolor: '#FF9A00' }} />,
          'Suitable',
          row_data['Suitable'] / 10,
          (row_data['Suitable'] * 100 / total).toFixed(2),
          (row_data['Suitable Population'] * 0.16 / 1000000)
        ...
        createData(
          <Box sx={{ width: '100%', height: 13, borderRadius: 0, bgcolor: '#FFD700' }} />,
          'Moderately Suitable',
          row_data['Moderately Suitable'] / 10,
          (row_data['Moderately Suitable'] * 100 / total).toFixed(2),
          (row_data['Moderately Suitable Population'] * 0.16 / 1000000)
        ),
        createData(
          <Box sx={{ width: '100%', height: 13, borderRadius: 0, bgcolor: '#06D001' }} />,
          'Suitable with adaptation benefits',
          row_data['Suitable with adaptation benefits'] / 10,
          (row_data['Suitable with adaptation benefits Population'] * 100 / total).toFixed(2),
          (row_data['Suitable with adaptation benefits Population'] * 0.16 / 1000000)
        ),
      ];
            ...
            <div>
              <Box sx={{ display: "flex" }}>
                <Typography
                  ...
                  color="black"
                >
                  Farm households under different categories of{" "}
            ...
            >
              {rows.map((row, index) => (
                ...
                >
                  ...
                  <Box>
                    <Typography
                      sx={{ fontSize: 10.5, fontWeight: "bold", margin: "2px" }}
                      color="black"
                    >
                      {" "}
                    ...
                    {row.Cat === "Suitable" && (
                      <Typography
                        sx={{ fontSize: 10, fontWeight: "normal" }}
                        color="black"
                      >
                        {" "}
