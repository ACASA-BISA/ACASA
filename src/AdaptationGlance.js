        ...
        >
            ...
            >
              ...
              >
                ...
                <AccordionDetails sx={{ marginY: "-5px" }}>
                  This overview page allows you to select a specific crop and
                  region of your choice, and explore the associated adaptation
                  options comprehensively on one page.
                </AccordionDetails>
              </Accordion>
            </div>
          </Popper>
          ...
          >
            ...
            >
              ...
              ></Summ_Comm>
              <Typography
                sx={{ marginLeft: "5px", fontSize: 14, fontWeight: "bold" }}
              >
                Location:{" "}
              </Typography>
              <Summ_Loc
        ...
        <SMap activeCrop={crop2} focus={focus2} activeRegion={activeRegion2} activeOpt={option} CurrRisk={CurrRisk2}></SMap>
          ...
          >
            <div>
              ...
              >
                <Typography sx={{ fontSize: 12 }}>Adaptation: </Typography>
                <Summ_Adapt
                  activv={opt2}
