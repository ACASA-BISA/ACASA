...
export default function SwitchRisk({ changeRisk, activeCrop, activeScenario }) {
 ...
 */
  const switchHazards = [
    ...
    "Lodging",
    "Frost",
    "Spikelet Sterility - Cold",
    "Spikelet Sterility - Heat",
    "Spikelet Sterility - Rainfall",
  ];
  const switchHazardsID = ["hindex", "DEMON", "TEMLO", "TEMUP", "COLLO", "RAINF", "HIRHI", "DRYSP", "DROMO", "DROSE", "LODGE", "FROST", "SPICO", "SPIHE", "SPIRA"];
  ...
  const [DisableList, setDisable] = React.useState(PopulateOptions);
            ...
            {switchChild.map((sname1, index1) => (
              <FormGroup>
                <CustomFormControlLabel
                  control={<AntSwitch inputProps={{ "aria-label": "ant design" }} checked={P2a[switchChildID[index1]]} onChange={handleChange2a(switchChildID[index1])} name={switchChildID[index1]} />}
                  disabled={false}
                ...
                {P2a[switchChildID[index1]] && switchChildID[index1] === "pr" && (
                  <FormControl component="fieldset" variant="standard" sx={{ paddingBottom: 1, paddingLeft: 5 }}>
                    {switchPro.map((sn1, idx) => (
                      <FormGroup>
                        <CustomFormControlLabel
                          control={<AntSwitch inputProps={{ "aria-label": "ant design" }} checked={P3[switchProID[idx]]} onChange={handleChangeP3(switchProID[idx])} name={switchProID[idx]} />}
                          disabled={false}
                          key={switchProID[idx]}
                          label={
                            <Typography variant="body2" sx={{ paddingLeft: 1 }}>
                                ...
                                <CustomFormControlLabel
                                  control={
                                    <AntSwitch
                                      ...
                                      checked={P3[switchHazardsID[idxr]]}
                                      onChange={handleChangeP3(switchHazardsID[idxr])}
                                      name={switchHazardsID[idxr]}
                                    />
                                  }
        ...
        {activeScenario["ssp245"] && (
          <FormControl component="fieldset" variant="standard" sx={{ paddingBottom: 1, paddingLeft: 3 }}>
            {switchChild.map((sname1, index1) => (
              <FormGroup>
                <CustomFormControlLabel
                  control={<AntSwitch inputProps={{ "aria-label": "ant design" }} checked={P2b[switchChildID[index1]]} onChange={handleChange2b(switchChildID[index1])} name={switchChildID[index1]} />}
                  disabled={false}
                  key={switchChildID[index1]}
                  label={
                    <Typography variant="body2" sx={{ paddingLeft: 1 }}>
                ...
                {P2b[switchChildID[index1]] && switchChildID[index1] === "pr" && (
                  <FormControl component="fieldset" variant="standard" sx={{ paddingBottom: 1, paddingLeft: 5 }}>
                    {switchPro.map((sn1, idx) => (
                      <FormGroup>
                        <CustomFormControlLabel
                          control={<AntSwitch inputProps={{ "aria-label": "ant design" }} checked={P3[switchProID2[idx]]} onChange={handleChangeP3(switchProID2[idx])} name={switchProID2[idx]} />}
                          disabled={false}
                  ...
                  <FormControl component="fieldset" variant="standard" sx={{ paddingBottom: 1, paddingLeft: 5 }}>
                    {switchIPCC.map((sn1, idx) => (
                      <FormGroup>
                        <CustomFormControlLabel
                          control={
                            <AntSwitch inputProps={{ "aria-label": "ant design" }} checked={P3bipcc[switchIPCCID[idx]]} onChange={handleChangeP3bipcc(switchIPCCID[idx])} name={switchIPCCID[idx]} />
                          }
                          disabled={false}
                          key={switchIPCCID[idx]}
                          label={
                              ...
                              <FormGroup>
                                <CustomFormControlLabel
                                  control={
                                    <AntSwitch
                                      inputProps={{ "aria-label": "ant design" }}
                                      checked={P3[switchRiskID[idxr].concat("2")]}
                                      onChange={handleChangeP3(switchRiskID[idxr].concat("2"))}
                                      name={switchRiskID[idxr].concat("2")}
                                    />
                                  }
                                  disabled={false}
                              ...
                              <FormGroup>
                                <CustomFormControlLabel
                                  control={
                                    <AntSwitch
                                      inputProps={{ "aria-label": "ant design" }}
                                      checked={P3[switchHazardsID[idxr].concat("2")]}
                                      onChange={handleChangeP3(switchHazardsID[idxr].concat("2"))}
                                      name={switchHazardsID[idxr].concat("2")}
                                    />
                                  }
                                  disabled={false}
                              ...
                              <FormGroup>
                                <CustomFormControlLabel
                                  control={
                                    <AntSwitch
                                      inputProps={{ "aria-label": "ant design" }}
                                      checked={P3[switchVulnerID[idxr].concat("2")]}
                                      onChange={handleChangeP3(switchVulnerID[idxr].concat("2"))}
                                      name={switchVulnerID[idxr].concat("2")}
                                    />
                                  }
                                  disabled={false}
                              ...
                              <FormGroup>
                                <CustomFormControlLabel
                                  control={
                                    <AntSwitch
                                      inputProps={{ "aria-label": "ant design" }}
                                      checked={P3[switchExposureID[idxr].concat("2")]}
                                      onChange={handleChangeP3(switchExposureID[idxr].concat("2"))}
                                      name={switchExposureID[idxr].concat("2")}
                                    />
                                  }
                                  disabled={false}
