      ...
      <Router>
        <AppBar
          ...
          sx={{
            ...
            height: AppBarHeight,
            boxShadow: (theme) =>
              theme.palette.mode === "dark" ? "0px 0px 4px #222" : "0px 0px 4px #aaa",        
          }}
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            <Box
              sx={{
                ...
                height: "18px",
                boxShadow: (theme) =>
        theme.palette.mode === "dark" ? "-2px #222" : "-2px #ccc",
      backgroundColor: (theme) =>
        theme.palette.mode === "dark" ? "#61c258" : "#4b9e44",
              }}
            >
              <Translate />
            </Box>
            ...
            <Toolbar disableGutters>
              <Box
                sx={{ display: "flex", flexGrow: 0, flexDirection: "column" }}
              >
                <Button
                  size="small"
                  href=""
              ...
              <Box
                display="flex"
                justifyContent="right"
                sx={{ flexGrow: 0.97, display: { xs: "none", md: "flex" }, }}
              >
                <ToggleButtonGroup
                  value={flag}
                  exclusive
                        ...
                        <div ref={GlanceButtonRef}>
                          <MyButton
                            ...
                            sx={{
                              ...
                              paddingTop: 1,
                              paddingBottom: 1,
                              backgroundColor: (theme) => Boolean(anchorElUser)
                              ? theme.palette.mode === "dark" 
                                ? "#3a3d42"  // Dark theme open menu color
                                : "#f5f3ed"  // Light theme open menu color
                              : theme.palette.mode === "dark" ? "#3a3d42" : "#ffffff",  // Darkens when menu is open
                            }}
                            key={pageid[index]}
                            ...
                            >
                              <MenuItem onClick={handleClick}>
                                <Typography
                                  textAlign="center"
                                  fontSize={13}
                                  sx={{ fontFamily: "Karla", fontWeight: 350, color: (theme) => theme.palette.mode === "dark" ? "#dddddd" : "#222222", }}
                                >
                                  Hazards at a glance
                                </Typography>
                              </MenuItem>
