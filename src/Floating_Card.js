  ...
  const optcode = {'Stress Tolerant Variety':'ADVAR','Early Sowing':'ADPTI','Precision Land Levelling':'LASLV','Zero Tillage with residue':'ZTILL','Broad Bed and Furrow':'BBFIB',
    ...
    function fetchthedataPie() {
      ...
      if(adaption!==''){
        ...
        data = [
          ...
          { value: (row_data['Suitable']*100/total).toFixed(2), label: 'Suitable' },
          { value: (row_data['Adaptation Benefits']*100/total).toFixed(2), label: 'Suitable with adaptation benefits' },
        ];
        //console.log(data);
      }
      return data;
    ...
    function fetchthedataPieHzd() {
      ...
      if(RiskName!==''){
        ...
        data = [
          ...
          { value: (row_data['Low']*100/total).toFixed(2), label: 'Low' },
    ...
    function fetchthedataTable() {
      ...
      if(adaption!==''){
        ...
        data = 
        [
          createData(<Box sx={{width: 60,height: 13,borderRadius: 1,bgcolor: 'rgba(180, 70, 109, 1)',marginY:'2px'}}/>,'Unsuitable', row_data['Unsuitable']/10, (row_data['Unsuitable']*100/total).toFixed(2), row_data['Unsuitable_Area']/1000000),
          createData(<Box sx={{width: 60,height: 13,borderRadius: 1,bgcolor: '#FF9A00',marginY:'2px'}}/>,'Suitable', row_data['Suitable']/10, (row_data['Suitable']*100/total).toFixed(2), row_data['Suitable_Area']/1000000),
          createData(<Box sx={{width: 60,height: 13,borderRadius: 1,bgcolor: '#06D001',marginY:'2px'}}/>,'Suitable with adaptation benefits', row_data['Adaptation Benefits']/10, (row_data['Adaptation Benefits']*100/total).toFixed(2), row_data['Adaptation Benefits_Area']/1000000),
        ];
        //console.log(data);
      }
      return data;
