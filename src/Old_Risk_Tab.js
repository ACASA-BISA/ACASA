...
export default function SwitchRisk2({ changeRisk, activeCrop, activeScenario, CurrRisk }) {
                ...
                {P2a[switchChildID[index1]] && switchChildID[index1] === "ipcc" && (
                  <FormControl component="fieldset" variant="standard" sx={{ paddingBottom: 1, paddingLeft: 5 }}>
                    {switchRisk.map((sn1r, idxr) => (
                      <FormGroup>
                        <CustomFormControlLabel
                          control={<AntSwitch inputProps={{ "aria-label": "ant design" }} checked={P3[switchRiskID[idxr]]} onChange={handleChangeP3(switchRiskID[idxr])} name={switchRiskID[idxr]} />}
                          disabled={false}
                                ...
                                <CustomFormControlLabel
                                  ...
                                  label={
                                    <Typography
                                      variant="body2"
                                      align="left"
                                      sx={{ paddingLeft: 1, maxWidth: "200px", wordBreak: "break-word", whiteSpace: "normal" }}
