...
export default function SwitchFish({ activeCrop, changeCrop }) {
  const switchh = ["Freshwater", "Brackish", "Marine", "Cold water"];
  const switchid = ["freshwater", "bracklish", "marine", "coldwater"];
