...
export default function MApp({
  ...
  const color2 = {
    color: [
      ...
      [
        "rgba(0,0,0,0)",
        "rgba(0,0,0,0)",
        mode === "dark" ? "rgba(255, 128, 150, 1)" : "rgba(180, 70, 109, 1)",
        "#FF9A00",
        "#06D001",
        "rgba(0,0,0,0)",
      ],
  ...
  const color4 = {
    color: [
      ...
      [
        "rgba(0,0,0,0)",
        "rgba(0,0,0,0)",
        mode === "dark" ? "#06d6a0" : "#059212",
        mode === "dark" ? "#00e676" : "#00FF00",
        mode === "dark" ? "#ffeb3b" : "#FFFF00",
        mode === "dark" ? "#ffa726" : "#FFA500",
        mode === "dark" ? "#ff7043" : "#FF0000",
        mode === "dark" ? "#577590" : "#3b528b",
        mode === "dark" ? "#43aa8b" : "#21918c",
        mode === "dark" ? "#90be6d" : "#5ec962",
        mode === "dark" ? "#fde725" : "#fde725",
      ],
    ],
  };
  ...
  const color_hazard = {
    color: [
      ...
      [
        "rgba(0,0,0,0)",
        mode === "dark" ? "rgba(200,200,200,1)" : "rgba(150,150,150,1)",
        mode === "dark" ? "#06d6a0" : "#059212",
        mode === "dark" ? "#00e676" : "#00FF00",
        mode === "dark" ? "#ffeb3b" : "#FFFF00",
        mode === "dark" ? "#ffa726" : "#FFA500",
  ...
  const color_hazard_25 = {
    color: [
      ...
      [
        "rgba(0, 0, 0, 0)",
        "rgba(0, 0, 0, 0)",
        mode === "dark" ? "rgba(72, 61, 139, 1)" : "rgba(0, 0, 139, 1)", // Class 1
        mode === "dark" ? "rgba(100, 149, 237, 1)" : "rgba(70, 130, 180, 1)", // Class 2
        mode === "dark" ? "rgba(135, 206, 235, 1)" : "rgba(0, 191, 255, 1)", // Class 3
        mode === "dark" ? "rgba(60, 179, 113, 1)" : "rgba(50, 205, 50, 1)", // Class 4
        mode === "dark" ? "rgba(255, 223, 0, 1)" : "rgba(255, 255, 0, 1)", // Class 5
        mode === "dark" ? "rgba(255, 165, 0, 1)" : "rgba(255, 165, 0, 1)", // Class 6
        mode === "dark" ? "rgba(255, 69, 0, 1)" : "rgba(204, 51, 0, 1)", // Class 7
        mode === "dark" ? "rgba(165, 42, 42, 1)" : "rgba(128, 0, 0, 1)", // Class 8
        mode === "dark" ? "rgba(75, 0, 130, 1)" : "rgba(128, 0, 0, 1)", // Class 9
        mode === "dark" ? "rgba(100, 149, 237, 1)" : "rgba(70, 130, 180, 1)", // Class 10
        mode === "dark" ? "rgba(135, 206, 235, 1)" : "rgba(0, 191, 255, 1)", // Class 11
        mode === "dark" ? "rgba(60, 179, 113, 1)" : "rgba(50, 205, 50, 1)", // Class 12
        mode === "dark" ? "rgba(255, 223, 0, 1)" : "rgba(255, 255, 0, 1)", // Class 13
        mode === "dark" ? "rgba(255, 165, 0, 1)" : "rgba(255, 165, 0, 1)", // Class 14
        mode === "dark" ? "rgba(255, 69, 0, 1)" : "rgba(204, 51, 0, 1)", // Class 15
        mode === "dark" ? "rgba(165, 42, 42, 1)" : "rgba(128, 0, 0, 1)", // Class 16
        mode === "dark" ? "rgba(75, 0, 130, 1)" : "rgba(128, 0, 0, 1)", // Class 17
        mode === "dark" ? "rgba(100, 149, 237, 1)" : "rgba(70, 130, 180, 1)", // Class 18
        mode === "dark" ? "rgba(135, 206, 235, 1)" : "rgba(0, 191, 255, 1)", // Class 19
        mode === "dark" ? "rgba(60, 179, 113, 1)" : "rgba(50, 205, 50, 1)", // Class 20
        mode === "dark" ? "rgba(255, 223, 0, 1)" : "rgba(255, 255, 0, 1)", // Class 21
        mode === "dark" ? "rgba(255, 165, 0, 1)" : "rgba(255, 165, 0, 1)", // Class 22
        mode === "dark" ? "rgba(255, 69, 0, 1)" : "rgba(204, 51, 0, 1)", // Class 23
        mode === "dark" ? "rgba(165, 42, 42, 1)" : "rgba(128, 0, 0, 1)", // Class 24
        mode === "dark" ? "rgba(75, 0, 130, 1)" : "rgba(128, 0, 0, 1)", // Class 25
      ],
    ],
  };
  ...
  const colorGradientEx = {
    color: [
      ...
      "rgba(0,0,0,0)",
      10,
      mode === "dark" ? "#FFF176" : "#FFF9C4",
      20,
      mode === "dark" ? "#FFD54F" : "#FFE680",
      30,
      mode === "dark" ? "#FFC107" : "#FFD700",
      40,
      mode === "dark" ? "#B8860B" : "#DAA520",
      50,
      mode === "dark" ? "#8B4513" : "#A0522D",
      60,
      mode === "dark" ? "#5C4033" : "#6B3D1B",
    ],
  };
  ...
  useEffect(() => {
    ...
    if (mapRef.current) {
      ...
      layers.forEach((layer) => {
        if (layer.getSource() instanceof TileJSON) {
          mapRef.current.removeLayer(layer); // Only remove basemap layers
        }
      });
    }

    // Define new base map source
    ...
    if (ref.current && !mapRef.current) {
      ...
      mapRef.current = new Map({
        controls: [
          ...
          new DownloadControl({ className: "download-button" }),
        ],
        target: ref.current,
        layers: [BingMapNew],
        view: ViewV,
  ...
  }, [mode, ref, mapRef]); // Now listens for mode changes
  ...
  }, [activeOptLayer, activeOpt, mapRef, mode]);
