...
export default function DrawerMapShow({ activeBar }) {
  ...
  const opt = [
    ...
    "Heating management",
    "Mechanical cooling",
    "Modify sheds, planting tress, bathing, and mechanical cooling, wallowing",
    "Modify shelters",
    "Shelter for natural hazards",
    "Modify sheds, planting tress, ventilation, roof height",
    "Modify sheds, planting tress, bathing, and mechanical cooling",
    "Fat supplementation",
    ...
    "Adoption of climate resillient breed/strain",
    ...
    "Climate information servics and safetynets",
    "Diversification",
  ];
